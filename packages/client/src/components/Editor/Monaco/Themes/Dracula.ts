...
export const Dracula = (theme?: EditorPropsInstance['theme']) => {
  const testsetter = null;
  return {
    base: 'vs-dark',
    inherit: true,
    rules: [
    ...
    colors: {
      'editor.foreground': theme?.editor?.foreground ?? '#f8f8f0',
      'editor.background': theme?.editor?.background ?? '#15171c',
      'editor.lineHighlightBackground':
        theme?.editor?.lineHighlightBackground ?? '#15171c',
      ...
      // 'editor.background': '#3e1313',
      // 'editor.lineHighlightBackground': '#f8f8f0',
      // 'editor.selectionBackground': '#3e1313',
      // 'editorCursor.foreground': '#f8f8f0',
      // 'editorWhitespace.foreground': '#3B3A32',
      // 'editorIndentGuide.activeBackground': '#9D550FB0',
      // 'editor.selectionHighlightBorder': '#222218',
